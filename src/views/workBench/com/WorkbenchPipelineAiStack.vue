...
<template>
  ...
  >
      ...
      <el-col :xs="24" :sm="5">
        ...
        >
          ...
          <div class="pending-glass-foot" @click.stop>
            ...
            <el-tooltip content="导出功能会生成「两高一弱」专项报告（高危漏洞、高危端口、弱口令）。" placement="top">
              <el-button size="small" class="pending-glass-info-btn" @click.stop>
                <el-icon>
                  <InfoFilled />
                </el-icon>
              </el-button>
          ...
          <div class="disposition-glass-head">
            <div class="disposition-glass-head-left">
              ...
              <div class="disposition-glass-titles">
                ...
                <span class="disposition-glass-subtitle">智能研判与自动化响应</span>
              </div>
            </div>
          ...
          <div class="disposition-glass-body">
            ...
            >
              <div class="disposition-glass-empty-inner">
                <div class="disposition-glass-empty-icon-wrap" aria-hidden="true">
                  <el-icon><Check /></el-icon>
                </div>
                <p class="disposition-glass-empty-title">暂无待执行任务</p>
                <p class="disposition-glass-empty-desc">当前的筛选条件下没有待处置项，或已全部处理完毕</p>
              </div>
            </div>

            <div v-else-if="dispositionLoading" class="disposition-glass-loading-hint">加载任务中…</div>

            <div v-else class="disposition-glass-scroll">
              <el-card shadow="never" class="emergency-card">
                <div class="emergency-inner" :class="'emergency-inner--' + dispositionCategoryKind">
                  <div v-if="emergencyCategoryTagText" class="emergency-corner-tag">
                    <el-tag
                      :type="emergencyCategoryTagType"
                      effect="dark"
                      size="small"
                    >{{ emergencyCategoryTagText }}</el-tag>
                  </div>
                  <div class="emergency-header">
                    ...
                    <div class="emergency-header-titles">
                      <div class="emergency-header-title">{{ emergencyTaskTitle }}</div>
                      <div
                        v-if="
                      ...
                      >
                        <span v-if="emergencyTaskCreateTime" class="emergency-meta-item">
                          <el-icon aria-hidden="true"><Clock /></el-icon>
                          创建：{{ emergencyTaskCreateTime }}
                        </span>
                        <span v-if="emergencyTaskUpdateTime" class="emergency-meta-item">
                  ...
                  <div class="emergency-body" :class="'emergency-body--' + dispositionCategoryKind">
                    ...
                    <template v-if="dispositionCategoryKind === 'weak'">
                      ...
                      <div v-if="emergencyCredentialPair" class="emergency-credential">
                    ...
                    <template v-else-if="dispositionCategoryKind === 'port'">
                      <div class="emergency-spot emergency-spot--port">
                        ...
                        <div v-if="emergencyProtocol" class="emergency-port-sub">
                          <span class="emergency-kv-k">协议</span>
                          <span class="emergency-kv-v">
                            {{
                            emergencyProtocol
                    ...
                    <template v-else>
                      ...
                      <div class="emergency-meta-row">
                        ...
                        <template v-if="emergencyVulnNumber">
                          <span class="emergency-meta-sep">•</span>
                          <span class="emergency-meta-pair emergency-meta-pair--wide">
                      ...
                      <div v-if="emergencyDescribe" class="emergency-desc">{{ emergencyDescribe }}</div>
                    </template>
                  </div>

                  <div class="emergency-actions">
                    <el-button type="danger" size="small" @click="emitGovernEmergency">立即治理</el-button>
                  </div>
                </div>
              </el-card>
            </div>
    ...
    <!-- <PendingTasksListModal
      v-model:visible="pendingTasksModalVisible"
...
/>
    ...
    <VulnRiskDisposeDialog
      v-model:visible="vulnDisposeDialogVisible"
    ...
    <PortRiskDisposeDialog
      v-model:visible="portDisposeDialogVisible"
      :items="governDisposeItems"
      :task-row="governSelectedTodoRow"
    ...
    <WeakPasswordRiskDisposeDialog
      v-model:visible="weakDisposeDialogVisible"
      :items="governDisposeItems"
      :task-row="governSelectedTodoRow"
...
export default {
  ...
  methods: {
    ...
    async handleDisposeDialogGenerateReport(category, payload) {
      ...
      const overrideIds =
        ...
        payload.vulnIds.length
          ...
          : null;
      const todoRow =
        this.governSelectedTodoRow || this.dispositionRawRow || {};
    ...
    handleDisposeConvergenceConfirm(payload) {
      ...
      const policyType =
        payload && payload.policyType ? payload.policyType : "";
